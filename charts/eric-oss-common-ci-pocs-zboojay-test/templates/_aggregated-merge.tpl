...
*/ -}}
{{- define "eric-oss-common-ci-pocs-zboojay-test.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-oss-common-ci-pocs-zboojay-test.mergeAnnotations" -}}
  {{- include "eric-oss-common-ci-pocs-zboojay-test.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}
{{- define "eric-oss-common-ci-pocs-zboojay-test.mergeLabels" -}}
  {{- include "eric-oss-common-ci-pocs-zboojay-test.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}
